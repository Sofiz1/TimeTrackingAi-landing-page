    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden selection:bg-emerald-500/30">
      ...
      <nav className="glass-nav flex items-center justify-between px-8 py-4">
        ...
        <div className="hidden md:flex items-center gap-8">
          <a href="#features" className="text-zinc-400 hover:text-emerald-400 Transition">Features</a>
          <a href="#security" className="text-zinc-400 hover:text-emerald-400 Transition">Security</a>
          <a href="#feedback" className="text-zinc-400 hover:text-emerald-400 Transition">Feedback</a>
          <a 
            href="/assets/TimeTrackingAI_v1.1.zip" 
      ...
      {/* Hero Section */}
      <header className="pt-40 pb-20 px-[10%] max-w-[1400px] mx-auto grid lg:grid-cols-2 gap-20 items-center">
        <motion.div 
        ...
        >
          ...
          <p className="text-lg text-zinc-400 mb-10 max-w-[500px] font-light leading-relaxed">
          ...
          {downloadCount !== null && (
            <div className="flex items-center gap-2 mb-6 text-emerald-400/80 text-sm font-medium">
              <Download size={16} />
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="/assets/TimeTrackingAI_v1.1.zip" onClick={handleDownload} className="btn-primary flex items-center justify-center gap-2">
              <Download size={20} />
        ...
        >
          <div className="relative rounded-3xl overflow-hidden border border-white/10 shadow-[0_40px_120px_rgba(0,0,0,0.9)] animate-floating group-hover:scale-[1.02] transition-transform duration-700">
            <Image 
              src="/assets/hero.png" 
      ...
      <section id="security" className="py-32 px-[10%] max-w-[1400px] mx-auto grid lg:grid-cols-2 gap-20 items-center">
        ...
        <div>
          ...
          <h2 className="text-5xl font-bold tracking-tight mb-8">Your data stays <span className="text-emerald-500 italic">your data</span>.</h2>
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-16">
          <div>
            ...
            <div className="p-6 bg-emerald-500/5 border border-emerald-500/10 rounded-2xl">
              ...
              <p className="text-sm text-zinc-500 italic">"Designed with passion for precision." – Sofonias Hagos</p>
            </div>
          </div>
          ...
          <form onSubmit={handleFeedbackSubmit} className="space-y-4">
            ...
            <button 
              ...
              className="w-full bg-emerald-500 text-black font-bold py-4 rounded-xl flex items-center justify-center gap-2 hover:bg-emerald-400 transition disabled:opacity-50"
            >
            ...
            {submitStatus === "success" && (
              <p className="text-emerald-500 text-sm font-medium animate-pulse">Feedback sent successfully! Thank you.</p>
            )}
            {submitStatus === "error" && (
              <p className="text-red-400 text-sm font-medium">Failed to send feedback. Please try again.</p>
            )}
          </form>
        </div>
      </section>
